...
const App = () => {
  const popUpEvents = [
    ...
    { id: "4", image: require("../../assets/images/eleventh.png") },
    { id: "5", image: require("../../assets/images/fifteenth.png") },
  ];

  const thriftEvents = [
    { id: "6", image: require("../../assets/images/fourth.jpeg") },
    { id: "7", image: require("../../assets/images/fifth.jpeg") },
    { id: "1", image: require("../../assets/images/first.jpeg") },
    { id: "9", image: require("../../assets/images/tenth.jpg") },
    { id: "10", image: require("../../assets/images/twelfth.jpg") },
  ];

  const friendActivities = [
    { id: "11", image: require("../../assets/images/seventh.jpeg") },
    { id: "12", image: require("../../assets/images/eighth.jpeg") },
    { id: "13", image: require("../../assets/images/ninth.jpeg") },
    { id: "7", image: require("../../assets/images/fifth.jpeg") },
    { id: "4", image: require("../../assets/images/eleventh.png") },

  ];

// State to track bookmarked items with their overlay text
const [bookmarked, setBookmarked] = useState<{ id: string; image: any; textOverlay: string }[]>([]);

// Toggle bookmark state for a specific image
const toggleBookmark = (item: { id: string; image: any }, textOverlay: string) => {
  setBookmarked((prev) => {
    ...
    renderItem={({ item, index }) => (
      <View style={styles.imageContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => toggleBookmark(item, textOverlay[index])}
        >
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        {renderImages(popUpEvents, ["Outdoor @ Rio","Nespresso","Spin the Wheel", "Block Show", "Indie on the Lawn"])}
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Closest thrift events</Text>
        {renderImages(thriftEvents, ["Joyful Finds","Thrift Shift","Outdoor @ Rio", "Lawson Boutiques", "BooksRUs"])}
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>What your friends are up to</Text>
        {renderImages(friendActivities, ["Open Air Bazaar","Vintage Corner","Urban Oasis","Thrift Shift", "Block Show"])}
      </View>
    ...
    <FlatList
      ...
      renderItem={({ item }) => (
        <View style={styles.imageContainer}>
          <Image source={item.image} style={styles.image} />
          <View style={styles.overlay}>
            <Text style={styles.overlayText}>{item.textOverlay}</Text>
          </View>
        </View>
      )}
    />
